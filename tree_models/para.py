...
params = {
    ...
    "mu_ys": [0.02, 0.05],     # Mean of the state variables , 0.08, 0.11, 0.14, 0.17, 0.2, 0.23, 0.26, 0.3
    "sig_ys": [0.02, 0.05],    # Std of the state variables , 0.08, 0.11, 0.14, 0.17, 0.2, 0.23, 0.26, 0.3
