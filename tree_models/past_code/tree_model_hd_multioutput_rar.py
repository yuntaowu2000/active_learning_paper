...
def train_loop(params):
    ...
    for epoch in pbar:
        ...
        total_loss, hjb_kappas_, consistency_kappas_ = TP.loss_fun_Net1(kappa_nn, valid_Z)
        ...
        if params["resample_times"] > 0 and (epoch + 1) % (epochs // params["resample_times"]) == 0:
